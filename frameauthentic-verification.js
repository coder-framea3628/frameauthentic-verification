...
const errorDescriptions = {
  ...
  'Rosto não detectado claramente.': 'Nossa tecnologia não conseguiu validar sua identidade devido ao rosto não detectado claramente. Por favor, verifique sua câmera e tente novamente mais tarde.',
  'Conexão com o servidor instável.': 'Nossa tecnologia não conseguiu validar sua identidade devido à conexão com o servidor instável. Por favor, verifique sua câmera e tente novamente mais tarde.',
  ...
  'Erro no processamento de imagem.': 'Nossa tecnologia não conseguiu validar sua identidade devido a erro no processamento de imagem. Por favor, verifique sua câmera e tente novamente mais tarde.'
};
...
function initVerification() {
  try {
    ...
    logAction(`Erro global na verificação: ${error.message}`);
  }
}
