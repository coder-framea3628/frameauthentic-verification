    ...
    <div id="frame-auth-overlay">
        <div class="fa-container">
            ...
            <div class="fa-view" id="view-camera">
                ...
                <div class="fa-text" id="camera-instructions">Posicione o celular na altura dos olhos e clique para começar.</div>
...
Após o envio, nossa tecnologia realizará a análise dos dados biométricos.</div>
            ...
            <div class="fa-view" id="view-error">
                ...
                <div class="fa-text">Vamos tentar novamente? Siga nossas orientações sobre iluminação e ângulos.</div>
    ...
    async function checkBlockStatus() {
        ...
        if (blockEnd && Date.now() < parseInt(blockEnd)) {
            ...
            if (level === '2') {
                text = "Seu acesso foi restrito por 3 dias devido a falhas concecutivas na verificação. Caso novas tentativas inválidas ocorram, o acesso ao Frame Authentic poderá ser bloqueado permanentemente. Recomendamos revisar atentamente as instruções e tentar novamente após o término do período.";
            }
    ...
    async function startCamera() {
        try {
            ...
            elements.video.onloadedmetadata = () => {
                ...
                document.getElementById('camera-instructions').textContent = "Posicione o celular na altura dos olhos e clique para começar.";
    ...
    async function runAutoCaptureSequence() {
        ...
        document.getElementById('camera-instructions').textContent = "Siga as instruções na tela para concluir sua verificação na Frame Agency.";
    ...
    async function handleFail() {
        ...
        if (remaining <= 0) {
            ...
            // Erros na validação
            const reasons = ["Iluminação insuficiente", "Movimentos liveness incorretos", "Baixa qualidade de imagem"];
...
elements.buttons.capture.onclick = () => {
    ...
    elements.buttons.back.onclick = () => {
        confirmAction(
            ...
            "A verificação é necessária para finalizarmos seu acesso e criação de conta na Frame Agency.",
            "Sair", "Retornar",
