...
(function() {
    ...
    const CONFIG = {
        ...
        images: {
            ...
            watermark: 'https://framerusercontent.com/images/XbZR6AhvUOAL5XimIaJ00gqSZU.png'
        }
    };
    ...
    <div id="frame-auth-overlay">
        <div class="fa-container">
            ...
            <div class="fa-view" id="view-review">
                ...
                <div class="fa-text">Certifique-se de que seu rosto está nítido e sem reflexos. Ao enviar, nossa tecnologia fará a análise dos dados biométricos.</div>
                <div class="fa-camera-wrapper">
                ...
                <div class="fa-compare-container">
                    ...
                    <div class="fa-compare-box">
                        <div style="width:100%; height:100%; background:#eee; display:flex; align-items:center; justify-content:center;">
                             <img src="https://framerusercontent.com/images/XbZR6AhvUOAL5XimIaJ00gqSZU.png.png" style="width:60%; opacity:0.5;">
                        </div>
            ...
            <div class="fa-view" id="view-locked">
                ...
                <div class="fa-text">Limite de tentativas atingido por falhas consecutivas na verificação facial.
Por segurança, aguarde o prazo antes de tentar novamente.</div>
    ...
    async function startCamera() {
        try {
            ...
            elements.video.onloadedmetadata = () => {
                ...
                document.getElementById('camera-instructions').textContent = "Posicione seu rosto e clique para iniciar a verificação.";
    ...
    elements.buttons.capture.onclick = () => {
        if (!state.cameraReady) {
            ...
            document.getElementById('camera-instructions').textContent = "Mantenha a face dentro da moldura e clique em 'Tirar foto' quando estiver pronto.";
