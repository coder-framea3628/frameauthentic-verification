...
(function() {
    ...
    style.textContent = `
        ...
        .fa-big-instruction {
            ...
            width: 100%; text-align: center; color: rgba(255,255,255,0.9); font-size: 17px; font-weight: 600;
...
Após o envio, nossa tecnologia realizará a análise dos dados biométricos.</div>
    ...
    async function runAutoCaptureSequence() {
        ...
        // Sequência
        await showInstruction("Mova a cabeça para a esquerda", 2500);
        await showInstruction("Mova a cabeça para a direita", 2500);
        await showInstruction("Olhe para frente", 2000);
        await showInstruction("Fique parado", 2500);
