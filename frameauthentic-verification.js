    ...
    <div id="frame-auth-overlay">
        <div class="fa-container">
            ...
            <div class="fa-view" id="view-desktop-qr" style="justify-content:center;">
                <div class="fa-title" style="font-family:'Poppins',sans-serif;">Escaneie para verificar</div>
                <div class="fa-text" style="font-family:'Poppins',sans-serif;">A verificação facial funciona melhor em dispositivos móveis.</div>
                ...
                <div class="fa-text" style="margin-top:20px; font-size:12px;">Use a câmera do seu celular</div>
            </div>
...
Após o envio, nossa tecnologia realizará a análise dos dados biométricos.</div>
    ...
    elements.buttons.capture.onclick = () => {
        if (!state.cameraReady) {
            ...
            startCountdownSequence(); // Countdown logic
        }
    };
