// ============================================================================
// FRAME AUTHENTIC - EXPERIÊNCIA PREMIUM DE VERIFICAÇÃO FACIAL (V2.0)
// ============================================================================

(function() {
    // 1. LIMPEZA INICIAL (Remove versões anteriores se houver)
    ...
    const CONFIG = {
        ...
        images: {
            ...
            watermark: 'https://framerusercontent.com/images/8eP5Buloi4fUryJ8u2WOGCAXMw.png'
        }
    };
    ...
    // 3. INJEÇÃO DE CSS (ESTILO PREMIUM)
    ...
    style.textContent = `
        ...
        .fa-header-title { font-weight: 600; font-size: 16px; flex-grow: 1; text-align: center; margin-right: 40px; }
        ...
        <div class="fa-container">
            ...
            <div class="fa-view active" id="view-intro">
                ...
                <div class="fa-tips">
                    ...
                    <div class="fa-tip-item">
                        ...
                        <div class="fa-tip-text">Seus dados são usados apenas para validação de segurança.</div>
                    </div>
                </div>
            ...
            <div class="fa-view" id="view-permission">
                <div style="flex:1; display:flex; flex-direction:column; justify-content:center; align-items:center;">
                    ...
                    <div class="fa-text">Para confirmar que é você, precisamos de acesso temporário à câmera do seu dispositivo.</div>
                </div>
            ...
            <div class="fa-view" id="view-review">
                ...
                <div class="fa-text">Certifique-se de que seu rosto está nítido e sem reflexos.</div>
                <div class="fa-camera-wrapper">
            ...
            <div class="fa-view" id="view-error">
                ...
                <div class="fa-title">Algo deu errado</div>
                ...
                <div class="fa-compare-container">
                    ...
                    <div class="fa-compare-box">
                        <div style="width:100%; height:100%; background:#eee; display:flex; align-items:center; justify-content:center;">
                             <img src="https://framerusercontent.com/images/8eP5Buloi4fUryJ8u2WOGCAXMw.png" style="width:60%; opacity:0.5;">
                        </div>
                        <div class="fa-compare-label" style="background:rgba(76, 175, 80, 0.8)">Ideal</div>
                    </div>
                </div>

                <div class="fa-text">Tente um local mais iluminado e não se mexa.</div>
            ...
            <div class="fa-view" id="view-locked">
                <div style="color:var(--fa-error); margin:30px 0;">${ICONS.lock}</div>
                <div class="fa-title">Acesso Bloqueado</div>
                <div class="fa-text">Você atingiu o limite de tentativas. Por segurança, aguarde para tentar novamente.</div>
    ...
    async function startCamera() {
        try {
            ...
            elements.video.onloadedmetadata = () => {
                ...
                document.getElementById('camera-instructions').textContent = "Posicione seu rosto e clique para iniciar.";
    ...
    function processVerification() {
        ...
        elements.processingTitle.textContent = "Validando rosto...";
        ...
        setTimeout(() => {
            ...
            elements.processingTitle.textContent = "Verificando segurança...";
            
            setTimeout(() => {
                // Etapa 3: FALHA (Sempre falha conforme regra)
                handleFail();
            }, 2000);
        }, 2000);
    }
    ...
    function handleFail() {
        ...
        if (remaining <= 0) {
            ...
            // Erro comum
            const reasons = ["Iluminação insuficiente", "Rosto não centralizado", "Movimento detectado"];
    ...
    elements.buttons.capture.onclick = () => {
        if (!state.cameraReady) {
            ...
            document.getElementById('camera-instructions').textContent = "Mantenha a face dentro da moldura.";
    ...
    elements.buttons.back.onclick = () => {
        ...
        if(confirm("Deseja sair da verificação?")) {
            window.location.href = "https://google.com"; // Substitua pelo link fornecido
        }
    };
